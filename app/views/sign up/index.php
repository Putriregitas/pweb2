...
<head>
    ...
    <link href="<?= BASEURL; ?>/css/assets/bootstrap.css" rel="stylesheet" />
    <link href="<?= BASEURL; ?>/css/assets/ct-paper.css" rel="stylesheet" />
    <link href="<?= BASEURL; ?>/css/assets/demo.css" rel="stylesheet" />
    <link href="<?= BASEURL; ?>/css/assets/examples.css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation-example-2">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="<?= BASEURL; ?>/signIn" class="btn btn-primary">Logout</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                    ...
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 ">
                        <div class="register-card">
                            ...
                            <form class="register-form">
                                ...
                                <input type="text" class="form-control" placeholder=" Ekspresikan dirimu !">

                                <label>Password</label>
                                <input type="password" class="form-control" placeholder="Password">

                                <button class="btn btn-danger btn-block" class="btn btn-primary">sign up</button>
                            </form>
...
<script src="<?= BASEURL; ?>/assets/bootstrap-datepicker.js"></script>
