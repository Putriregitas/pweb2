...
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="<?= BASEURL; ?>/assets/paper_img/favicon.ico">
    ...
    <link href="<?= BASEURL; ?>/assets/css/hipster_cards.css" rel="stylesheet"/>
    ...
    <div class="container">
        <div class="page-description page-description-header">
            <div class="hipster-container">
                <h1 class="text-center">Baca kumpulan artikel favoritmu ^-^</h1>
            </div>
        </div>
        ...
        <div class="masonry-container">
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card">
                    <div class="header">
                        <img src="<?= BASEURL; ?>/assets/paper_img/lifestyle-8.jpg"/>
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/lifestyle-1.jpg">
                    <div class="header">
                        <div class="category">
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card">
                    <div class="header">
                        <img src="<?= BASEURL; ?>/assets/paper_img/beard-1.jpg" />
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/lifestyle-2.jpg">
                    <div class="header">
                        <div class="category">
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card card-with-border" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/fashion-1.jpg">
                    <div class="header">
                    </div>
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card card-just-text card-with-border" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/lifestyle-9.jpg">
                    <div class="content">
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card text-center" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/city-2.png">
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card card-just-text card-with-border" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/music-3.jpg">
                    <div class="content">
...
No diggity, I gotta bag it up."</h4>
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card" data-background="color" data-color="black">
                    <div class="header">
                        <img src="<?= BASEURL; ?>/assets/paper_img/home-1.jpg"/>
            ...
            <div class="card-box col-md-4 col-sm-6">
                <div class="card text-center" data-background="image" data-src="<?= BASEURL; ?>/assets/paper_img/city-1.jpg">
	...
	<script src="<?= BASEURL; ?>/assets/js/hipster-cards.js"></script>
